    ...
    return (
      <div className='footer'>
        ...
        <div className='footer-layer-2'>
         <a href='https://github.com/PredictMe' target="_blank"> <div className='github-item'><img className='github-logo' src='github-logo-01.svg' alt='github logo'/><div className='github-text'>Github</div></div></a>
